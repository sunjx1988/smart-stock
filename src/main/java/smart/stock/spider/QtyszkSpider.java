...
@Slf4j
@Component
public class QtyszkSpider extends StockFinanceSpider {

    @Autowired
    private QtyszkPipeline qtyszkPipeline;


    @Override
    protected StockFinancePipeline getStockFinancePipeline() {
        return qtyszkPipeline;
    }

    @Override
    protected Constants.FinanceInfoTypes getFinanceInfoTypes() {
        return Constants.FinanceInfoTypes.QTYSZK;
    }
}
