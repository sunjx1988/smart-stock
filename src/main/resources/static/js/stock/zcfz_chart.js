var ZcfzChartPage = (function(){
    ...
    function getParam() {
        var param = $("#zcfzForm").serializeObject();
        param.paramStockId = $("#id").val();
        return param;
    }

    function initEvents() {
        $("#zcfzSearchBtn").on("click", function () {
            initChart();
        });

        $("#zcfzForm #paramStartYear").selecter({
        ...
        $("#zcfzForm #paramEndYear").selecter({
            url: "/stock_finance/date_options",
            param:{
                stockId :$("#id").val()
            }
        ...
        $("#zcfzForm #paramDateType").selecter({
    ...
    return {
        init: function () {
            myChart = echarts.init(document.getElementById('zcfzChart'));
            initChart();
            initEvents();
        }
    }
